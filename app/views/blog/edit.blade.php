...
<div class=" w cnt_box">
 @include('blog.nav')
    <div class="container">
        ...
        <div class="text-form">
            <ul>
                <li ><span>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题:</span><input type="text" name="title" value="{{{$blog->title}}}"></li>
                <li class="author"><span>作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;者:</span><input type="text" name="author" value="{{{$blog->author}}}"></li>
                <li class="colum"><span>隶属栏目:</span><input type="text" name="colum" value="{{{$blog->colum}}}"></li>
                <li  class="short_news"><span>信息摘要:</span><input type="text" name="short_desc" value="{{{$blog->short_desc}}}"></li>
			...
			<p>
                ...
                <li class="sure_sub"><input type="hidden" name="gid" value="{{{$blog->gid}}}"><input type="submit" value="添加文章"></li>
            </ul>
        </div>
        {{ Form::close() }}
    </div>
